            ...
            <table class="min-w-full divide-y divide-slate-200 text-sm">
                ...
                @forelse($expenses as $expense)
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-5 py-4 text-slate-600">{{ $expense->assembly?->name ?? 'Unassigned' }}</td>
                        <td class="px-5 py-4">
                ...
                @empty
                    <tr>
                        <td colspan="8" class="px-5 py-12 text-center text-sm text-slate-500">No expense records have been captured yet.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
