...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-2xl font-bold text-gray-800 mb-6">Add/Edit Member</h1>

            <div class="bg-white shadow-md rounded-lg p-6 mb-6">
                <div class="mb-4">
                    <label for="memberSearch" class="block text-gray-700 text-sm font-bold mb-2">Search Member</label>
                    <input type="text" id="memberSearch"
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                           placeholder="Type name, email or phone...">
                    <div id="searchResults" class="hidden mt-2 border rounded bg-white max-h-60 overflow-y-auto"></div>
                </div>
            </div>

            <div class="bg-white shadow-md rounded-lg p-6" id="memberFormContainer">
